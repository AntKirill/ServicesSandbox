...
public final class TrelloLocalServerReceiver implements VerificationCodeReceiver {
     ...
     * </p>
     */
    public TrelloLocalServerReceiver() {
        this(LOCALHOST, -1, CALLBACK_PATH);
    }
     ...
     */
    TrelloLocalServerReceiver(String host, int port) {
        this(host, port, CALLBACK_PATH);
    }
     ...
     * @param port Port to use or {@code -1} to select an unused port
     */
    TrelloLocalServerReceiver(String host, int port, String callbackPath) {
        this.host = host;
        this.port = port;
    ...
    public String getRedirectUri() throws IOException {
        ...
        server.addHandler(new TrelloLocalServerReceiver.CallbackHandler());
        try {
            server.start();
    ...
    public static final class Builder {
         ...
         */
        public TrelloLocalServerReceiver build() {
            return new TrelloLocalServerReceiver(host, port, callbackPath);
        }
    ...
    class CallbackHandler extends AbstractHandler {
        ...
        private void writeLandingHtml(HttpServletResponse response) throws IOException {
            ...
            doc.println("<script>\n" +
                    ...
                    "}\n" +
                    "var tokenPart = window.location.hash.substr(1);\n" +
                    "httpGet(\"http://localhost:8888/Callback?\" + tokenPart);" +
                    "</script>\n");
